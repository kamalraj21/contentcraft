...
This reflects real past employment at Intel. Business-impact figures (adoption numbers, ticket deflection rates) were not tracked in a form I can cite honestly. The scope metrics above are structurally accurate: two toolchains, two platforms, full developer journey coverage. If a specific business metric becomes available, it will be added.
